 ...
 */
function calculateScore(metaResult, googleResult, competitorResult, modeOverride) {
  const mode = modeOverride || detectMode(metaResult, googleResult);
...
function verdictFor(s) {
  if (s >= 85) return "Elite. Full funnel, clean signals, systematic testing.";
  if (s >= 70) return "Strong. A few scaling rules left to unlock.";
